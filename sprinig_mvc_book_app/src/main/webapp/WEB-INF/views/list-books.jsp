...
<body>
	...
	<div class="container">
		...
		<!-- Add a search form -->
		<form action="/sprinig_mvc_book_app/books/search" class="form-inline">

			<!-- Add a button -->
			<a href="/sprinig_mvc_book_app/books/showFormForAdd"
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/sprinig_mvc_book_app/books/showFormForUpdate?bookId=${tempBook.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/sprinig_mvc_book_app/books/delete?bookId=${tempBook.id}"
